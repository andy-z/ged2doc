...
GEDCOM Utilities could always use more documentation, whether as part of the
official GEDCOM Utilities docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.6+. Check
   https://travis-ci.org/andy-z/ged2doc/pull_requests
